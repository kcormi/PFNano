...
filelist = [ 'file:' +fname for fname in filelist ]
...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('file:4321_lele_first_test.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:' + options.outname),
